...
- Self-Improve separation (no raw writes): PASS  (raw_inputs.jsonl sha256 unchanged)
  - evidence: raw_before=e3b0c44298fc raw_after=e3b0c44298fc proposal_path=/Users/openteam-dev/OpenTeam/openteam/.openteam/ledger/self_improve/20260217T091621Z-proposal.md
- Concurrency locks regression (unittest): PASS  (includes evals/test_concurrency_locks.py)
- Approvals DB write: PASS  (OPENTEAM_DB_URL=postgresql://temporal:***@127.0.0.1:15432/openteam)
...
- cmd: `/Users/openteam-dev/OpenTeam/openteam/openteam approvals list --limit 5`
- rc: 0
...
- cmd: `/Library/Developer/CommandLineTools/usr/bin/python3 /Users/openteam-dev/OpenTeam/openteam/scripts/pipelines/approvals.py --repo-root /Users/openteam-dev/OpenTeam/openteam --workspace-root /Users/openteam-dev/.openteam/workspace request --task-id OPENTEAM-0019 --action-kind repo_create --summary [E2E:20260217T091619Z] approvals db write check --role single --yes`
- rc: 0
...
- cmd: `/Users/openteam-dev/OpenTeam/openteam/openteam db migrate`
- rc: 0
...
- cmd: `/Library/Developer/CommandLineTools/usr/bin/python3 /Users/openteam-dev/OpenTeam/openteam/scripts/pipelines/requirements_raw_first.py --repo-root /Users/openteam-dev/OpenTeam/openteam --workspace-root /Users/openteam-dev/.openteam/workspace add --scope project:audit-e2e --text [E2E:20260217T091619Z] Add a feasible requirement for v3 verification. --workstream qa --priority P2 --source cli --user e2e`
- rc: 0
...
```text
{
  ...
  "pending_decisions": [],
  "actions_taken": [
    "raw_first.capture raw_id=RAW-4c9db51d76e1aba6 path=/Users/openteam-dev/.openteam/workspace/projects/audit-e2e/state/requirements/raw_inputs.jsonl",
  ...
  "raw_inputs_path": "/Users/openteam-dev/.openteam/workspace/projects/audit-e2e/state/requirements/raw_inputs.jsonl",
  "raw_assessments_path": "/Users/openteam-dev/.openteam/workspace/projects/audit-e2e/state/requirements/raw_assessments.jsonl",
  "feasibility_outcome": "FEASIBLE",
  "feasibility_report_path": "feasibility/RAW-4c9db51d76e1aba6.md",
  "baseline_version": 1,
  "baseline_path": "/Users/openteam-dev/.openteam/workspace/projects/audit-e2e/state/requirements/baseline/original_description_v1.md",
  "scope": "project:audit-e2e",
  "project_id": "audit-e2e",
  "requirements_dir": "/Users/openteam-dev/.openteam/workspace/projects/audit-e2e/state/requirements",
...
- cmd: `/Library/Developer/CommandLineTools/usr/bin/python3 /Users/openteam-dev/OpenTeam/openteam/scripts/pipelines/requirements_raw_first.py --repo-root /Users/openteam-dev/OpenTeam/openteam --workspace-root /Users/openteam-dev/.openteam/workspace add --scope project:audit-e2e --text [E2E:20260217T091619Z] 将项目 requirements 写入 openteam repo 并提交 --workstream qa --priority P1 --source cli --user e2e`
- rc: 0
...
```text
{
  ...
  "actions_taken": [
    "raw_first.capture raw_id=RAW-555e1605c03a3b8c path=/Users/openteam-dev/.openteam/workspace/projects/audit-e2e/state/requirements/raw_inputs.jsonl",
...
- cmd: `/Library/Developer/CommandLineTools/usr/bin/python3 /Users/openteam-dev/OpenTeam/openteam/scripts/pipelines/self_improve_daemon.py --repo-root /Users/openteam-dev/OpenTeam/openteam --workspace-root /Users/openteam-dev/.openteam/workspace run-once --scope openteam --force`
- rc: 0
...
```text
  ...
  "proposal_path": "/Users/openteam-dev/OpenTeam/openteam/.openteam/ledger/self_improve/20260217T091621Z-proposal.md",
  "applied_count": 3,
  "panel_sync": {
    "ok": true,
    "stdout_tail": [
      "- WOULD_CREATE_OR_UPDATE TASK OPENTEAM-0015 DONE",
      "- WOULD_CREATE_OR_UPDATE TASK OPENTEAM-0016 DONE",
      "- WOULD_CREATE_OR_UPDATE TASK OPENTEAM-0017 DONE",
      "- WOULD_CREATE_OR_UPDATE TASK OPENTEAM-0018 DONE",
      "- WOULD_CREATE_OR_UPDATE TASK OPENTEAM-0019 TODO",
