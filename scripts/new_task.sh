...
sed \
  ...
  "$ROOT/templates/task_ledger.yaml" >"$ledger_out"

render_log "$ROOT/templates/task_log_00_intake.md" "$logs_dir/00_intake.md"
render_log "$ROOT/templates/task_log_01_plan.md" "$logs_dir/01_plan.md"
render_log "$ROOT/templates/task_log_02_todo.md" "$logs_dir/02_todo.md"

if [[ "$FULL" -eq 1 ]]; then
  render_log "$ROOT/templates/task_log_03_work.md" "$logs_dir/03_work.md"
  render_log "$ROOT/templates/task_log_04_test.md" "$logs_dir/04_test.md"
  render_log "$ROOT/templates/task_log_05_release.md" "$logs_dir/05_release.md"
  render_log "$ROOT/templates/task_log_06_observe.md" "$logs_dir/06_observe.md"
  render_log "$ROOT/templates/task_log_07_retro.md" "$logs_dir/07_retro.md"
fi
