"""team_os_cli -- Team OS CLI package."""
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    na.add_argument("--remote-env-path", default="~/.teamos/node.env")
    ...
    oct_p.add_argument("--message", default="Team OS OpenClaw test message")
